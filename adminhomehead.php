            ...
            <div class="main_menu">
            	<nav class="navbar navbar-expand-lg navbar-light">
					<div class="container box_1620">
						...
						<a class="navbar-brand logo_h" href="index.html"><i><b><h2>event organisation</h2></b></i></a>
						...
						<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
							<ul class="nav navbar-nav menu_nav ml-auto">
								<li class="nav-item "><a class="nav-link" href="adminhome.php">My Detail</a></li> 
								<li class="nav-item "><a class="nav-link" href="addvenu.php">add venue</a></li>
								<li class="nav-item "><a class="nav-link" href="ahistory.php">booking history</a></li>
