					...
					<table border="1px">
						...
						<?php 
								  ...
								  while($data=mysql_fetch_array($q))
	                               {  ?>
								<tr>
									<td class="column1"> <?php echo $data['name'];?></td>
									<td class="column2"> <?php echo $data['address'];?></td>
									<td class="column3"><?php echo $data['adminid'];?></td>
									<td class="column4"><?php echo $data['password'];?></td>
								</tr><?php } ?>
						</tbody>
					</table><br>
					<center><a  href="editadmin.php?id=<?php echo $data['id']?>"><button>update</button></a>
					</center>
				</div>
			</div>
		</div>
