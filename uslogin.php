...
<body>
 <!--================Header Menu Area =================-->
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('uslogin/images/bg-02.jpg');">
			<div class="wrap-login100 p-t-30 p-b-50">
				<span class="login100-form-title p-b-41">
					User Login
				</span>
				<form class="login100-form validate-form p-b-33 p-t-5" action="userlogincheck.php" method="POST">
				...
				<div class="container-login100-form-btn m-t-32">
						<div>
							...
							<a href="userregister.php" class="txt1"><button class="login100-form-btn">
										or register
										</button>
							</a>
						</div>
